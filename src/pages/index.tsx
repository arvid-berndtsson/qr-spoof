...
export const metadata: Metadata = {
  ...
  description: "Learn about QR code security risks and how to protect yourself from quishing attacks.",
  openGraph: {
    title: "QR Code Security - Protect Yourself from Quishing",
    description: "Learn about QR code security risks and how to protect yourself from quishing attacks.",
        ...
        <div className="bg-red-600 text-white py-4">
          <div className="max-w-3xl mx-auto px-6">
            <div className="flex items-center justify-center space-x-2">
              <svg className="h-6 w-6 animate-pulse" viewBox="0 0 20 20" fill="currentColor">
        ...
        <div className="max-w-3xl mx-auto">
          <div className="text-center space-y-6">
            <h1 className="text-5xl font-bold tracking-tight text-gray-900 mb-4">
              {originalUrl ? "Stop! Think Before You Scan" : "QR Code Security Awareness"}
            </h1>
          ...
          <div className="space-y-8 mt-12">
            <div className="bg-red-50 p-8 rounded-2xl shadow-sm border border-red-100">
              <h2 className="text-2xl font-semibold text-red-900 mb-4">The Danger</h2>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">How to Stay Safe</h2>
            ...
            {originalUrl && (
              <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
                <h2 className="text-2xl font-semibold text-gray-900 mb-4">Continue to Website</h2>
                <p className="text-gray-600 mb-4">If you trust this QR code, you can continue to the original website:</p>
                <div className="bg-gray-50 p-4 rounded-lg mb-4">
                  <p className="text-sm text-gray-500 break-all">{originalUrl}</p>
                </div>
                <button
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">Spread Awareness</h2>
              <p className="text-gray-600 mb-6">
                Help others learn about QR code security by creating and sharing awareness QR codes.
              </p>
