...
export const metadata: Metadata = {
  ...
  description: "Understanding quishing and why we need to be more careful with QR codes in our daily lives.",
  openGraph: {
    title: "QR Codes, Trust, and a Quiet Reminder",
    description: "Understanding quishing and why we need to be more careful with QR codes in our daily lives.",
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-8 mt-12">
            <Section title="What is quishing?">
              <p>
                <strong>Quishing</strong> is phishing using QR codes. It's when attackers replace a link with a QR code, hoping you'll scan without thinking — leading to fake login pages, malware, or worse.
              </p>
              <p className="mt-4">
            ...
            <Section title="Why this project exists">
              ...
              <p className="mt-4">
                In the summer of 2024, I bought this domain, thinking I'd eventually do something with it. Then, while listening to an episode of the Swedish podcast <a
                  ...
                  >Cyber Chats & Chill</a>, I was reminded that I still owned it. That was the nudge I needed.
              </p>
              <p className="mt-4">
                So here we are.
              </p>
            ...
            <Section title="What this site actually does">
              <p>
                This site lets <strong>anyone</strong> generate a QR code that points here — a safe in-between page that encourages people to stop and think before they trust what's behind the scan.
              </p>
              <p className="mt-4">
            ...
            <Section title="Who I am">
              <p>
                Hi! I'm <a
                    ...
                    rel="noopener noreferrer"
                    className="text-[#29a587] hover:text-[#238f75]"
                  >Arvid Berndtsson</a>, a developer with a long-running interest in cybersecurity and the weird ways we interact with tech.
              </p>
              <p className="mt-4">
