      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          <div className="flex items-center">
            <Link
              href="/"
              className="flex items-center space-x-2 text-xl font-bold bg-gradient-to-r from-[#29a587] to-[#238f75] bg-clip-text text-transparent tracking-tight"
            >
              <svg className="w-6 h-6 text-[#29a587]" fill="currentColor" viewBox="0 0 20 20">
          ...
          <nav className="hidden sm:flex sm:items-center sm:space-x-1">
            <Link
              ...
              className={`text-sm font-medium px-4 py-2 rounded-xl transition-all duration-200 ${
                isActive("/")
                  ? "bg-gradient-to-r from-[#29a587]/10 to-[#238f75]/10 text-[#29a587]"
